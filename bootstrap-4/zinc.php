...
<link rel="stylesheet" href="css/font-awesome.min.css" />
  ...
  <meta name="author" content="Entreprise Antoine Couverture">
	<meta name="description" content="L'entreprise Antoine Couverture située à Saint Victor D'épine dans l'Eure est spécialisée dans la couverture en zinc et les gouttières.">
  ...
  <title>Antoine Couverture près de bernay et brionne, spécialisée dans le zinc.</title>
...
<aside class="col-7 col-offset-4 " >
    <br><br>
    <h4>La gouttière zinc est la plus courante. Brillant lors de la pose, le zinc s'auto protège par une couche anti corrosion grise clair mat en environ six mois suivant les intempéries .</h4>
    
<img src="image/page3.jpg" width="900" height="506" alt="Photo de  gouttière zinc" />
    
<img src="image/zinc2.jpg" width="900" height="506" alt="Photo de gouttière zinc" />
